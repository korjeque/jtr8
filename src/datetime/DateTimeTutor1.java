...
public class DateTimeTutor1 {
	...
	public static void main(String[] args) {
        ...
        // get current LocalDateTime by passing ZoneId.systemDefault() to now()
        // get NY LocalDateTime by passing time zone "America/New_York" to now()
        // calculate duration between these times and print it in hours
        LocalDateTime ldtCur = LocalDateTime.now( ZoneId.systemDefault() );
        LocalDateTime ldtNewYork = LocalDateTime.now( TimeZone.getTimeZone("America/New_York").toZoneId() );
        System.out.println( "Cur:" + ldtCur.format(DateTimeFormatter.ISO_DATE_TIME) );
        System.out.println( "NewYork:" + ldtNewYork.format(DateTimeFormatter.ISO_DATE_TIME) );
        System.out.println( Duration.between(ldtCur, ldtNewYork).toHours() );
